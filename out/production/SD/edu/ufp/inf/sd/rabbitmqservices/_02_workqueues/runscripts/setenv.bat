...
@Set WORKDRIVE=C
@Set JDK="C:\\Program Files\\Java\\jdk1.8.0_333"
...
@Set JAVA_JAVAXMAIL_TOOLS=%JAVA_LIB_FOLDER%\\javax.activation-1.2.0.jar;%JAVA_LIB_FOLDER%\\javax.mail-1.6.2.jar
@Set CLASSPATH=.;%JAVAPROJ_JAR_FILE%;%JAVA_RABBITMQ_TOOLS%;%JAVA_JAVAXMAIL_TOOLS%
