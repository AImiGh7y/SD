...
public class Gui extends JPanel {
	...
	// For communication with the edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.server
	...
	public void paintComponent(Graphics g) {
		...
		case PLAYING:
			...
			edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.gui.Terrain.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.gui.Ranges.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.gui.Cities.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.gui.Units.Draw(gg, Game.ScreenBase);
			edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.gui.Selector.Draw(frame, gg, Game.ScreenBase,
					Game.player.get(Game.btl.currentplayer).selectx,
					Game.player.get(Game.btl.currentplayer).selecty);
			edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.gui.SmallMenu.Draw(gg,frame);
		break;
		case EDITOR:
			gg.setColor(new Color(0,0,60));
			gg.fillRect(0, 0, width, height);
