 ...
 * Place MoveView(); in the game-loop (100ms) to automate it (Teleporting across the map between switching viewed edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.units / turns is automatic)
...
public class ViewPoint {
	...
	public void MoveView() {
		...
		if (edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.engine.Game.GameState == edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.engine.Game.State.PLAYING) {
			y = edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.engine.Game.player.get(edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.engine.Game.btl.currentplayer).selecty;
			x = edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.engine.Game.player.get(edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.engine.Game.btl.currentplayer).selectx;
		}
		else {
			y = edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.engine.Game.edit.selecty;
			x = Game.edit.selectx;
		}
		MoveNorth(y);
		MoveSouth(y);
