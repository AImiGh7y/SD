...
//import edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.server.Game;
import edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.menus.Credits;
import edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.menus.MenuHandler;
import edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.menus.Options;
import edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.menus.PlayerSelection;
...
public class StartMenu implements ActionListener {
	...
	private void refreshGamesList() {
		...
		try {
			for(edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.server.Game game: gameSessionRI.getGames()) {
	...
	@Override public void actionPerformed(ActionEvent e) {
		...
		if (s==New) {
			...
			try {
				edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.server.Game server_game = game.getGameSessionRI().getGame(uid);
