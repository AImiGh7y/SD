...
import edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.engine.Pathfinding;

/**
 * Depending on if a unit is selected by the current player and the edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.units state, it will draw the movement range (based on path finding outcome).
 ...
 * It will also draw the attackable locations depending on the edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.units max and min attack ranges.
 * @author SergeDavid
 * @version 0.3
 */
public class Ranges {
