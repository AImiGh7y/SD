...
public class TexturePack implements ActionListener {
	...
	public TexturePack(Game game) {//TODO: Add a return to default button.
		this.game = game;
		Point size = edu.ufp.inf.sd.rabbitmqservices._ProjetoSD.client.Advanced_Wars.menus.MenuHandler.PrepMenu(300,320);
		SetBounds(size);
		AddGui();
		AddListeners();
		MapListStuff(size);
