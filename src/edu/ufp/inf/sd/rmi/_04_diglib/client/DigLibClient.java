...
public class DigLibClient {
    ...
    private void playService() {
        try {
            ...
            this.digLibFactoryRI.register("Nuno", "ufp");
            DigLibSessionRI digLibSessionRI = this.digLibFactoryRI.login("Nuno", "ufp");
            Book[] books = digLibSessionRI.search("Distributed", "Tanenbaum");
