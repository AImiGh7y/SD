package edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players;
...
public class Base {
	...
	public int usedunits;//How many edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units does the player have left until turn ends. Currently unused.
	public int kills;
	public int loses;
	...
	/**The first special ability the player can use when the edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players power>level1. leave level1 at 0 to remove access to this ability.*/
