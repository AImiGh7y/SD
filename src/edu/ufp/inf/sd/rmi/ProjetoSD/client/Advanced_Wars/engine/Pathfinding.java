...
public class Pathfinding {
	...
	private edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base unit;
	...
	public Vector<Point> FindPath(edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base unit, int range) {
