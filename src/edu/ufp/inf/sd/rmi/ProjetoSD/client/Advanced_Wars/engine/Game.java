...
public class Game extends JFrame {
	...
	//This handles the different edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players and also is used to speed logic arrays (contains a list of all characters they own)
	public static List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players.Base> player = new ArrayList<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players.Base>();
	public static List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base> builds = new ArrayList<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base>();
	public static List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base> units = new ArrayList<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base>();
	//These are the lists that will hold commander, building, and unit data to use in the menu's
	public static List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players.Base> displayC = new ArrayList<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players.Base>();
	public static List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base> displayB = new ArrayList<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base>();
	public static List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base> displayU = new ArrayList<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base>();
	...
	public Game(GameSessionRI gameSessionRI) {
		super(name);
		...
		//Creates all the edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.gui elements and sets them up
		gui = new Gui(this);
		add(gui);
