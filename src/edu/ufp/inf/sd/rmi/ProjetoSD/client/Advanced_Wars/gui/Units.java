...
/**
 * This will draw all of the currently visible edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.
 * Units not owned by the current player are turned around. (Simple way of telling edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units with the same color apart)
...
public class Units {
	public static void Draw(Graphics2D g, int resize) {
		...
		for (edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base chars : Game.units) {
