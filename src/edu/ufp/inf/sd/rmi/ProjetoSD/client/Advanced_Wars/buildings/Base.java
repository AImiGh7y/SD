...
public class Base {
	...
	public Base(int owner,int xx, int yy) {
		//15 = Neutral, 12~14 are unused. (12 max edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players)
	...
	public void OpenMenu() {
		if (Menu!=null) {
			new edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.menus.City(Menu, x, y);
		}
	}
