 ...
 * Include if(showing) {edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.gui.add(this);} when changing edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.gui elements (As I remove all elements when changing between game states such as in game / main menu / editor)
 * @author SergeDavid
 * @version 0.2
 */
public class ErrorHandler extends JPanel {
	...
	/**This removes the error message from the edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.gui and sets the boolean to false.*/
