 ...
 * Place MoveView(); in the game-loop (100ms) to automate it (Teleporting across the map between switching viewed edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units / turns is automatic)
