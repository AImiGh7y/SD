...
public class LoadImages {
	...
	public LoadImages() {
		...
		Game.img_char = tool.getImage(getClass().getResource(path+"Units"+".png"));
		Game.img_tile = tool.getImage(getClass().getResource(path+"Terrain"+".png"));
		Game.img_city = tool.getImage(getClass().getResource(path+"Cities"+".png"));
		Game.img_exts = tool.getImage(getClass().getResource(path+"Extras"+".png"));
		Game.img_plys = tool.getImage(getClass().getResource(path+"Players"+".png"));
		Game.img_menu[0] = tool.getImage(getClass().getResource(path+"GameInfo"+".png"));
	}
