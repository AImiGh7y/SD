...
public class Editor {
	...
	public void AssButton() {
		...
		case CITY:
			AddBuilding();
			Game.map.map[selecty][selectx] = new edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.terrain.City();
		break;
		case UNIT:
	...
	public void ButtButton() {
		new edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.menus.EditorStuff();
	}
	
	private void AddBuilding() {
		moved = false;//Keeps game from generating lots of useless edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.
