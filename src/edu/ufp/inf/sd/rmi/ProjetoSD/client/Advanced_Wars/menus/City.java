...
/**
 * Displays a list of available edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units, and some information about them to buy.
 * @author SergeDavid
 * @version 0.2
 */
public class City implements ActionListener,ListSelectionListener {
	...
	private void ChangeAlt() {
		Alt.removeAll();
		edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base unit = Game.displayU.get(current);
