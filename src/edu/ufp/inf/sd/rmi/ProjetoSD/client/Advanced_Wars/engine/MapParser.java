...
public class MapParser {
	...
	private String encodeInfo() {//TODO: Total edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players. (start with 2, and add more depending on unit and building owners.)
	...
	private String encodeDesc() {
		//TODO: Replace name with current edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players name, and leave description for manliness?
	...
	private String CityID(edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base bld) {
		String a = "00";
	...
	private String UnitID(edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.units.Base unit) {
		String a = "00";
	...
	private List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base> FormatCities(List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base> oldblds) {
		List<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base> newblds = new ArrayList<edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.buildings.Base>();
	 ...
	 * xx = Map Width
	 * yy = Map Height
	 * x = Total edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players*/
	...
	/**This is for decoding the edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.terrain, it currently goes with 1 line = 1 row
	 * 2 = Byte
	 ...
	 * f = Owner (0-11 are edu.ufp.inf.sd.rmi.ProjetoSD.client.Advanced_Wars.players, 15 is neutral, 12-14 are unused)
	 * ff = type
	 * x location (x)
	 * y location (y)*/
